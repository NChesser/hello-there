        ...
        <ScreenContainer>
            <div className="space-y-5">
                ...
                <div className="flex gap-2">
                    <div
                        className={`flex-1 rounded-xl px-4 py-3 text-center ${isDark ? "bg-gray-800 border border-gray-700" : "bg-white border border-amber-100 shadow-sm"}`}
                    >
                        <p
                            className={`text-lg font-bold ${isDark ? "text-amber-400" : "text-amber-700"}`}
                        >
                            {userProgress.level}
                        </p>
                        <p
                            className={`text-xs ${isDark ? "text-gray-400" : "text-amber-600"}`}
                        >
                            Level
                        </p>
                    </div>
